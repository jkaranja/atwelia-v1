...
exports.zipDownload = exports.singleDownload = void 0;
...
const singleDownload = (req, res) => {
    ...
    const fullFilePath = path_1.default.resolve(__dirname, "../", "../", filePath);
    //check if file exists
    //returns null or err object //err.code='ENOENT'
    fs_1.default.stat(fullFilePath, (err, stat) => {
        if (err)
...
exports.singleDownload = singleDownload;
/**
 * @desc - Post all notes
...
const zipDownload = (req, res) => {
    ...
    fs_1.default.writeFileSync(output, zip.toBuffer());
